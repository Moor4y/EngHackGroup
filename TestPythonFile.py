...
arrProgram = ["Based on your responses, we think that you’d be a great fit for geological engineering! Studying soil and rock behaviour is your thing, because you like to solve complex problems around the world no matter what field it’s in! So many choices proven to never be a bore, whether it's working in oil & gas, mineral exploration, hazard waste removal, or groundwater management and lots more!",      #array to store program information
              ...
              "Based on your responses, we think that you’d be a great fit for systems design engineering! Criss cross, apple sauce, connect the dots and don’t look back, it's always a loss. See the bigger picture; you have an engineering degree with flexibility! Examining people, tools & software, is what you’ll do whether you work at startup or at the ride machines at a county fair. Are you indecisive? Perhaps. Do you like the idea of engineering but are clueless about your interests? Could be so. But are you also a quick learner whose knowledge spans beyond just one subject? Probably! Your options are wide open when you go into Systems Design due to the program’s flexibility to explore the topics YOU are interested in. Learn how all the engineering disciplines work together in a big picture perspective.",
